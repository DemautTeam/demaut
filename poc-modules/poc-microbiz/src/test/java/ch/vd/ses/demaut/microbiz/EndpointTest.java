...
public class EndpointTest {
    ...
    public void shouldStoreAnnexe() throws Exception {
        ...
        ContentDisposition contentDisposition = new ContentDisposition("attachment;filename=microbiz-test.cfg");

        FileInputStream fileInputStream = new FileInputStream("src/test/resources/microbiz-test.cfg");
